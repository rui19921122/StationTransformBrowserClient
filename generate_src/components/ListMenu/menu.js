...
class ListMenu extends React.Component {
    ...
    render() {
        ...
        const render_single_node = (item) => {
            ...
            let settings;
            if (this.props.menu.display_edit && this.props.user.managed_menu.indexOf(item.id) >= 0) {
            ...
            this.props.menu.display_edit && this.props.user.is_superuser ?
                React.createElement(antd_1.Input.Group, { style: {
                    ...
                    React.createElement("div", { className: "ant-input-group-wrap" },
                        React.createElement(antd_1.Button, { onClick: e => this.props.dispatch(menu_1.actions.add_menu(this.props.menu.adding_content)), disabled: this.props.menu.adding_content.length <= 0, loading: this.props.menu.adding_root_fetching, className: "ant-search-btn justify-button" }, "\u6DFB\u52A0"))) : '',
