        ...
        return (this.props.edit_article.article && this.props.edit_article.article.id ?
            React.createElement("div", null, 
                React.createElement(antd_1.Form, {onSubmit: handleSubmit, horizontal: true}, 
                    ...
                    React.createElement(FormItem, {label: "内容"}, getFieldDecorator('content', {})(React.createElement(editor_1.Editor, {initial_value: this.props.edit_article.article.content, key: this.props.article_id}))), 
