...
class FileModuleListView extends React.Component {
    ...
    render() {
        return (React.createElement(FileModuleLayout_1.FileModuleLayout, __assign({}, this.props), this.props.menu.list.length > 0 ? React.createElement("div", null, 
            React.createElement(antd_1.Row, {type: "flex", justify: "center"}, 
                React.createElement("h1", null, this.props.menu.list.find((value) => value.id == parseInt(this.props.params.id)).name)
            ), 
            React.createElement(SearchToolBar_1.SearchToolBar, {dispatch: this.props.dispatch, menu_id: parseInt(this.props.params.id), actions: {
