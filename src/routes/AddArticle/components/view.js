...
class FileModuleListView extends React.Component {
    ...
    render() {
        return (React.createElement(FileModuleLayout_1.FileModuleLayout, __assign({}, this.props), React.createElement(antd_1.Row, {type: "flex", justify: "center"}, React.createElement("h1", null, "添加文章")), React.createElement(antd_1.Row, {type: "flex", justify: "start"}, React.createElement(antd_1.Col, null, React.createElement(addArticleForm_1.ArticleFormComponent, __assign({}, this.props))))));
    }
}
