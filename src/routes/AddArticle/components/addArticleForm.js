...
class ArticleForm extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(antd_1.Form, { onSubmit: handleSubmit, horizontal: true },
            ...
            })(React.createElement(antd_1.Input, { type: "text", placeholder: "标题", id: "title", autoComplete: 'off' }))),
            ...
            })(React.createElement(antd_1.Select, null, this.props.menu.list.map(value => React.createElement(Option, { key: value.id + 'select', disabled: !(this.props.user.managed_menu.includes(value.id) || this.props.user.admin_menu.includes(value.id)), value: value.id.toString() }, value.name))))),
...
//# sourceMappingURL=addArticleForm.js.map